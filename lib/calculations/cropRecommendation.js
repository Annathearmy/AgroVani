...
function productCandidates(category, crop) {
  return PRODUCT_CATALOG
    ...
    .map(({ name, type, composition, targets }) => ({
      ...
      dosage: null,
      dosageGuidance: 'No dose is inferred from weather or an image alone. Confirm the registered crop, target, formulation, water volume, and safety interval on the current India label.',
    }))
}
